...
f5-copy = F5 Kopieren
f6-move = F6 Bewegen
f7-mkdir = F7 erst. Verz.
f8-delete = F8 Löschen
f9-Term = F9 Terminal
f10-quit = F10 Beenden
copy-tab = Kopiere aktuelles Tab zur anderen Seite
move-tab = Verschiebe aktuelles Tab zur anderen Seite
